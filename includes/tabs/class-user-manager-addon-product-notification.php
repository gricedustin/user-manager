			...
			<div class="um-admin-card-body">
				...
				<div id="um-product-notification-fields" style="<?php echo $enabled ? '' : 'display:none;'; ?>">
					...
					<div class="um-form-field">
						...
						<input type="color" id="um-product-notification-bg-color" name="product_notification_bg_color" value="<?php echo esc_attr($bg_color !== '' ? $bg_color : '#1e73be'); ?>"<?php echo $form_attr; ?> />
					</div>
					<div class="um-form-field">
						...
						<input type="color" id="um-product-notification-text-color" name="product_notification_text_color" value="<?php echo esc_attr($text_color !== '' ? $text_color : '#ffffff'); ?>"<?php echo $form_attr; ?> />
					</div>
					<div class="um-form-field">
						...
						<input type="color" id="um-product-notification-button-bg-color" name="product_notification_button_bg_color" value="<?php echo esc_attr($button_bg_color !== '' ? $button_bg_color : '#ffffff'); ?>"<?php echo $form_attr; ?> />
					</div>
					<div class="um-form-field">
						...
						<input type="color" id="um-product-notification-button-text-color" name="product_notification_button_text_color" value="<?php echo esc_attr($button_text_color !== '' ? $button_text_color : '#000000'); ?>"<?php echo $form_attr; ?> />
					</div>
					<div class="um-form-field">
						...
						<input type="color" id="um-product-notification-button-hover-bg-color" name="product_notification_button_hover_bg_color" value="<?php echo esc_attr($button_hover_bg_color !== '' ? $button_hover_bg_color : '#f1f1f1'); ?>"<?php echo $form_attr; ?> />
					</div>
					<div class="um-form-field">
						...
						<input type="color" id="um-product-notification-button-hover-text-color" name="product_notification_button_hover_text_color" value="<?php echo esc_attr($button_hover_text_color !== '' ? $button_hover_text_color : '#000000'); ?>"<?php echo $form_attr; ?> />
					</div>
				</div>
			</div>
		</div>
