	...
	public static function render(array $settings): void {
		...
		<div class="um-admin-card um-addon-collapsible" id="um-addon-card-quick-search" data-um-active-selectors="#um-quick-search-enabled">
			<div class="um-admin-card-header">
				...
				<h2><?php esc_html_e('WP-Admin Quick Search Bar', 'user-manager'); ?></h2>
			</div>
			<div class="um-admin-card-body">
				<div class="um-form-field">
					<label>
						<input type="checkbox" id="um-quick-search-enabled" name="um_quick_search_enabled" value="1" <?php checked($settings['um_quick_search_enabled'] ?? true); ?> />
						<?php esc_html_e('Activate WP-Admin Quick Search Bar', 'user-manager'); ?>
					</label>
					<p class="description">
