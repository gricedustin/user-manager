				...
				<div class="um-admin-card-body">
					<div class="um-doc-section">
						...
						<ul>
							...
							<li><strong><?php esc_html_e('User Experience', 'user-manager'); ?></strong> — <?php esc_html_e('Rebrand reset password copy, Coupon Email List Converter meta box, coupons email column, WooCommerce search-by-SKU redirect, Apply Coupon via URL parameter, display all post meta meta box, and allow editing of post meta (including add new custom fields).', 'user-manager'); ?></li>
