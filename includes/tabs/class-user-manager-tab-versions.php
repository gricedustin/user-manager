			...
			<div class="um-admin-card um-admin-card-full">
				...
				<div class="um-admin-card-body">
					<div class="um-changelog-item">
						<h4>2.5.97 <span>(March 16, 2026)</span></h4>
						<ul>
							<li><?php esc_html_e('When pipe-separated URL tag galleries are rendered, each pipe gallery section now includes 50px bottom spacing so sequential galleries have clearer visual separation.', 'user-manager'); ?></li>
						</ul>
					</div>
					<div class="um-changelog-item">
