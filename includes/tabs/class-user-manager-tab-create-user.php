				...
				<div class="um-admin-card-body">
					<form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="um-create-user-form">
						...
						<div class="um-form-field">
							...
							<input type="text" name="coupon_code_for_template" id="um-create-coupon-code" class="regular-text" list="um-create-coupon-code-datalist" placeholder="<?php esc_attr_e('Type to search or leave empty', 'user-manager'); ?>" value="" autocomplete="off" />
							<datalist id="um-create-coupon-code-datalist">
						...
						<div class="um-form-field">
							...
							<input type="text" name="allow_email_coupon_code" id="um-allow-email-coupon" class="regular-text" list="um-allow-email-coupon-datalist" placeholder="<?php esc_attr_e('Type to search or leave empty for none', 'user-manager'); ?>" value="" autocomplete="off" />
							<datalist id="um-allow-email-coupon-datalist">
								<?php if (!empty($coupons)) : ?>
									<?php foreach ($coupons as $coupon) : ?>
										<?php /** @var WC_Coupon $coupon */ ?>
										<option value="<?php echo esc_attr($coupon->get_code()); ?>"></option>
